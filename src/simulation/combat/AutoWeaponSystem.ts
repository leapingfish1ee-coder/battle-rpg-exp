...
export const SIDEARM_PROJECTILE_SPEED = 1040;
export const SIDEARM_PROJECTILE_DRAG_PER_SECOND = 0.18;
const SIDEARM_PROJECTILE_LIFETIME_SECONDS = 3.2;
const SIDEARM_PROJECTILE_RADIUS = 2;
const SIDEARM_PROJECTILE_MASS_SCALE = 1;
const SIDEARM_PROJECTILE_BASE_POWER = 1.25;
const SIDEARM_MUZZLE_OFFSET = 14;
...
export class AutoWeaponSystem {
  ...
  private fireSidearm(
    ...
    projectiles.push({
      ...
      initialSpeed: SIDEARM_PROJECTILE_SPEED,
      massScale: SIDEARM_PROJECTILE_MASS_SCALE,
      dragPerSecond: SIDEARM_PROJECTILE_DRAG_PER_SECOND,
      basePower: SIDEARM_PROJECTILE_BASE_POWER,
    });
  }
